...
typedef struct tagPlatform 
{
	...
	int32		Move		//플랫폼이 움직이는가: 0: 아니요 1: 가로 2 세로
} Platform;
...
/// </returns>
bool Platform_DetectIsGround(Platform* platform, struct Player* player);
...
void Map_DetectSavePoint(Map* map, struct Player* player);